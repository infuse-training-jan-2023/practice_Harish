...
class AutomateWebpage
    ...
    def check_login_status(url,usrname)
        ...
        sleep(5)
        login_status=framework_obj.get_text({xpath: "//*[@id=\"viewport\"]/div[4]/span/div/div/aside/div[2]/div/div/div/h2"})
        sleep(5)
...
driver_obj=webdriver_obj.instance_variable_get(:@driver)
automateWebpage_obj=AutomateWebpage.new(driver_obj)
